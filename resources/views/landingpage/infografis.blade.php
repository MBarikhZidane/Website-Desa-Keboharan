<x-landingpage.app :setting="$setting">
    ...
    <!-- Jumlah Penduduk -->
    <section
      class="max-w-6xl mx-auto grid grid-cols-2 sm:grid-cols-4 gap-4 px-4 mb-12"
    >
      ...
      <div class="bg-white p-6 rounded-xl shadow text-center">
        <img
          src="https://img.icons8.com/color/96/woman.png"
          class="mx-auto mb-2 w-12"
        />
      ...
      <div class="bg-white p-6 rounded-xl shadow text-center">
        <img
          src="https://img.icons8.com/color/96/man.png"
          class="mx-auto mb-2 w-12"
        />
  ...
  <div class="container max-w-6xl mx-auto px-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      @foreach($dataAgama as $agama)
        <div class="bg-white rounded-2xl shadow-sm p-5 flex items-center space-x-4 border border-gray-100">
          <img
            src="
  ...
  new Chart(document.getElementById("pendidikanChart"), {
    ...
    options: {
      ...
      scales: {
        y: { beginAtZero: true, title: { display: true, text: "Jumlah Jiwa" } },
      },
    },
  });
</script>
