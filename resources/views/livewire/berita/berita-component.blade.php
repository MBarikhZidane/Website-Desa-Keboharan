    ...
    <main class="p-6">
        <div class="bg-white p-6 rounded-lg shadow">
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-lg font-bold">Daftar Berita</h2>
                    ...
                    <tbody>
                        @forelse($beritas as $index => $berita)
                            <tr class="border-b border-gray-200-700">
                                <td class="p-3">{{ $beritas->firstItem() + $index }}</td>
                                <td class="p-3"> <img src="{{ asset('storage/' . $berita->image) }}" alt="Gambar"
                                        class="w-24 h-24 object-cover rounded-lg border"></td>
                                <td class="p-3">{{ $berita->title }}</td>
                                <td class="p-3">{{ $berita->author }}</td>
                                <td class="p-3">{{ $berita->category }}</td>
