...
class PengeluaranComponent extends Component
{
    ...
    {
        $pendapatan = Pengeluaran::findOrFail($id);
    ...
    public function update()
    {
        ...
        if ($this->selectedId) {
            $pendapatan = Pengeluaran::find($this->selectedId);
            $pendapatan->update([
                'name' => $this->name,
                'tahun' => $this->tahun,
                'total_anggaran' => $this->total_anggaran,
    ...
    {
        Pengeluaran::destroy($this->selectedId);
    ...
    {
        $pendapatans = Pengeluaran::orderBy('id', 'desc')->paginate(10);
        return view('livewire.anggaran.pengeluaran-component', compact('pendapatans'));
    }
}
